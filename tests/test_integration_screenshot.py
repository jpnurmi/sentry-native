...
@pytest.mark.skipif(
    sys.platform != "win32" and (sys.platform != "linux" or not is_qt),
    reason="Screenshots are only supported on Windows, or with Qt integration on Linux",
)
